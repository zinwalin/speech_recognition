...
typedef void IntegerResultHandler(int errorCode);
...
class SpeechRecognition {
  ...
  IntegerResultHandler recognitionError;
  ...
  Future _platformCallHandler(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case "speech.onRecognitionComplete":
        ...
        break;
      case "speech.onError":
        recognitionError(call.arguments);
        break;
      default:
  ...
  void setRecognitionError(IntegerResultHandler handler) =>
